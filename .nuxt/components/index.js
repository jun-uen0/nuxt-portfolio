...
export const ButtonSeeProjectAndCode = () => import('../../components/Button/SeeProjectAndCode.vue' /* webpackChunkName: "components/button-see-project-and-code" */).then(c => wrapFunctional(c.default || c))
