...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog.vue?vue&type=template&id=0b386df8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"wrapper-small"},[_vm._ssrNode("<div class=\"text-center mt-2 border-b-2 pb-3\"><h3 class=\"text-xl md:text-2xl lg:text-3xl text-gray-700 font-semibold\">Welcome to my blog.</h3></div> "),_c('Search'),_vm._ssrNode(" "),_vm._l((_vm.posts),function(post){return _vm._ssrNode("<div class=\"my-10 bg-gray-100 p-4 md:p-6 rounded-xl shadow-md\">","</div>",[_vm._ssrNode("<div class=\"flex justify-between items-center\"><span class=\"font-semibold text-gray-600 text-sm\">"+_vm._ssrEscape(_vm._s(_vm.formatDate(post.createdAt)))+"</span> <span class=\"px-3 py-1 bg-gray-600 text-white text-sm font-bold rounded\">"+_vm._ssrEscape(_vm._s(post.tag))+"</span></div> "),_vm._ssrNode("<div class=\"mt-2\">","</div>",[_c('nuxt-link',{staticClass:"text-xl md:text-2xl text-gray-700 font-bold hover:text-gray-600 hover:underline",attrs:{"to":post.slug}},[_vm._v(_vm._s(post.title)+"\n      ")]),_vm._ssrNode(" <p class=\"mt-2 text-base lg:text-lg text-gray-700\">"+_vm._ssrEscape(_vm._s(post.description))+"</p>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\" mt-4\">","</div>",[_c('nuxt-link',{staticClass:"text-primary font-semibold hover:underline",attrs:{"to":post.slug}},[_vm._v("Read more")])],1)],2)})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog.vue?vue&type=template&id=0b386df8&

// EXTERNAL MODULE: ./components/Search.vue + 4 modules
var Search = __webpack_require__(52);
...
installComponents(component, {Search: __webpack_require__(52).default})
